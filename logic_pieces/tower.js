...
export function logicTower( piece ) {   
    ...
    const counters = {
        left:  { status: false, cont: piece.column , foundKing: false },
        right: { status: false, cont: piece.column , foundKing: false },
        top:   { status: false, cont: piece.row    , foundKing: false },
        down:  { status: false, cont: piece.row    , foundKing: false }
    }
